...
interface CourseHomeSidebarItemProps {
    label: string;
    id: string;
    courseId: string;
    isLocked: boolean;
    type: string; // Differentiates between chapters and quizzes
}
...
export const CourseHomeSidebarItem = ({
    ...
    const onClick = () => {
        if (type === "chapter") {
            ...
            router.push(`/coursesHome/${courseId}/quizzesHome/${id}`);
        }
    };
