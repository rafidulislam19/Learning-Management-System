...
export const SidebarItem = ({
    ...
    const isActive = 
    (pathname === "/home" && href === "/home") || pathname === href || pathname.startsWith(`${href}/home`)
    ...
    return ( 
        ...
        className={cn(
            ...
            isActive && "text-sky-700 dark:text-sky-500 bg-sky-200/20 hover:bg-sky-200/20 hover:text-sky-700"
        )}>
